...
const {sman17,postjob, search, Path14, Path3, postjob1, postjob2,postjob3, postjob4, dog,mechanic, searchimg1, searchimg2, searchimg3, cleaning,Gardeners ,handyman,Rectangle1 ,Rectangle2 ,Rectangle3 , Rectangle4} = images;
            ...
            <View style={styles.container}>
                <View style={styles.flexrow}>   
                    <View>
                        ...
                        <Text style={styles.top2}>Post a Job Todays?</Text>
                    </View>
                    <Image source={sman17} style={styles.topimg} />
                </View>
                ...
                <View  style={styles.centerimage}>
                    ...
                    <View style={styles.postjob}>
                        <Image source={postjob} style={styles.postjobimg}/>
                        <Text style={styles.postjobtxt}>Post a Job</Text>
                    </View>
                </View>
                <View style={styles.flexrow}>
