...
const Jobpost = () =>  {
        ...
        const values = ['Chose your job type', 'Option A', 'Option B', 'Option C'];  
        const skillvalues = ['Skills required', 'Option A', 'Option B', 'Option C'];
        ...
        <View style={styles.whiteback}>
            ...
            <View style={styles.content} >
                ...
                <View style={styles.contenttext}>
                    ...
                    <Text style={styles.contenttxt2}>Estimated budget</Text>
                </View>
                <View style={styles.contenttext1}>
                    <Image source={Jobpost8} style={styles.privacy}/>
                    <Text style={styles.contenttxt2}>About your Job</Text>
                </View>
            ...
            <View style={styles.modal}>
                <Text style={styles.modaltxt} >Do you want to delete this Post Job ?
                </Text>
                <View style={styles.flexrow} >
                    <Text style={styles.mbutton} >Yes</Text>
                    <Text style={styles.mbutton} >No</Text>
                </View>
