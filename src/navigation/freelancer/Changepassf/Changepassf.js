        ...
        <View style={styles.whiteback}>
            ...
            <View style={styles.content} >
                <View style={styles.contenttxt1}>
                    ...
                    <TextInput style={styles.contenttxt2} placeholder="Current Password" />
                </View>
                <View style={styles.contenttxt1}>
                    <Image source={password} style={styles.privacy}/>
                    <TextInput style={styles.contenttxt2}  placeholder="New Password" />
                </View>
                <View style={styles.contenttxt1}>
                    <Image source={login} style={styles.privacy}/>
                    <TextInput style={styles.contenttxt2}  placeholder="Confirm Password" />
                </View>
