        ...
        <View style={styles.whiteback}>
            <View style={styles.toprect}>
                <View style={styles.container}>
                    ...
                    <Text style={styles.top1}>Orders Details</Text>
                </View>
            </View>
                ...
                <View>
                    <ScrollView horizontal style={styles.scrollview}>
                        ...
                        <View style={styles.button2}>
                            <Text style={styles.buttontxt2}>Pending Orders</Text>
                        </View>
                        <View style={styles.button3}>
                            <Text style={styles.buttontxt2}>Inprogress Orders</Text>
                        </View>
                        <View style={styles.button4}>
                            <Text style={styles.buttontxt2}>Complete Request Orders</Text>
                        </View>
                    </ScrollView>
                </View>
