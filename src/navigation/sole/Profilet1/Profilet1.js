...
const Jobpost = () =>  {
        ...
        const values = ['Video/Voice Chat', 'Option A', 'Option B', 'Option C'];  
        const paymentvalues = ['Payment', 'Option A', 'Option B', 'Option C'];
        const subscriptvalues = ['Subscription', 'Option A', 'Option B', 'Option C']; 
        const logoutvalues = ['Logout', 'Option A', 'Option B', 'Option C']; 
